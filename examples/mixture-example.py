...
from aviary.roost.mixtures.data import MixtureData
...
def input_parser():
    ...
    parser.add_argument(
        "--delimiter", default="+",
        help="Delimiter for mixture components in data."
    )

    parser.add_argument(
        "--comp-nodes", action="store_true", help="Instatiate nodes for each compound."
    )

    parser.add_argument(
        "--elem-nodes", action="store_true", help="Instatiate nodes for each element."
    )

    parser.add_argument(
        "--hom-edges", action="store_true", help="Element-Element and Compound-Compound edges."
    )

    parser.add_argument(
        "--het-edges", action="store_true", help="Element-Compound edges."
    )
